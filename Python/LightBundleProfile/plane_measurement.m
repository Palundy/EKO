...
x_offset = 12 - 4 + 0.5; %cm
y_offset = 5.5 - 4; %cm
granularity_x = 1; %cm
granularity_y = 0.5; %cm
...
xlabel('x [cm]');
ylabel('y [cm]');
zlabel('Comp. Irradiance [W/m²]');
title('Gaussian Interpolation of Irradiance');
subtitle("Granularity: "+granularity+" cm, Amount of datapoints: "+length(compensated_intensity), 'Color', '#787777')
